...
import { parseStreamAmount } from './utils/format';
...
export const MULTISIG_ALLOWANCE = new BN(parseStreamAmount('1'));
...
export class AccountMultisig extends Account {
    ...
    async getRequestIds(): Promise<string[]> {
        ...
        // TODO: https://github.com/stream/core-contracts/blob/305d1db4f4f2cf5ce4c1ef3479f7544957381f11/multisig/src/lib.rs#L84
...
export class Account2FA extends AccountMultisig {
    ...
    ********************************/
    ...
    public helperUrl = 'https://helper.testnet.streamprotocol.app';
