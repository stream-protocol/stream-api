...
export class JsonRpcProvider extends Provider {
     ...
     */
    async experimental_protocolConfig(blockReference: BlockReference | { sync_checkpoint: 'genesis' }): Promise<StreamProtocolConfig> {
     ...
     * @see [https://github.com/streamprotocol/NEPs/blob/master/specs/ChainSpec/LightClient.md#light-client-proof](https://github.com/streamprotocol/NEPs/blob/master/specs/ChainSpec/LightClient.md#light-client-proof)
     */
            ...
            try {
                ...
                if (response.error) {
                    if (typeof response.error.data === 'object') {
                        ...
                        // TODO: Fix when https://github.com/stream-protocol/stream-core/issues/1839 gets resolved
