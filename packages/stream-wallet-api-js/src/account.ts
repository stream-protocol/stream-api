...
export interface FunctionCallOptions {
    ...
    gas?: BN;
    /** amount of STREAM (in yoctoSTREAM) to send together with the call */
    attachedDeposit?: BN;
    /**
 ...
 *
 * @hint Use {@link walletAccount!WalletConnection} in the browser to redirect to [STREAM Wallet](https://wallet.streamprotocol.app/) for Account/key management using the {@link key_stores/browser_local_storage_key_store!BrowserLocalStorageKeyStore}.
...
export class Account {
     ...
     *
     * @param viewFunctionCallOptions.contractId STREAM account where the contract is deployed
