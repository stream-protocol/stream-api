...
export class UrlAccountCreator extends AccountCreator {
     ...
     * This is [hosted here](https://helper.streamprotocol.com) or set up locally with the [stream-contract-helper](https://github.com/streamprotocol/stream-contract-helper) repository
     * @param newAccountId The name of the STREAM account to be created
     * @param publicKey The public key from the masterAccount used to create this account
     * @returns {Promise<void>}
     */
